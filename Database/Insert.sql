...
-- Insertar vuelos con diferentes fechas
INSERT INTO vuelos (id, numero_vuelo, fecha_salida, hora_salida, ciudad_origen, ciudad_destino, aviones_id, capitanes_id, hora_llegada, fecha_llegada) VALUES
(43, 1201, DATE_ADD(CURDATE(), INTERVAL 2 MONTH), '08:00:00', 'Lima', 'Bogotá', 1, 1, '11:00:00', DATE_ADD(CURDATE(), INTERVAL 2 MONTH)),
(44, 1202, DATE_ADD(CURDATE(), INTERVAL 2 MONTH), '14:30:00', 'Lima', 'Santiago', 2, 2, '19:00:00', DATE_ADD(CURDATE(), INTERVAL 2 MONTH)),
(45, 1203, DATE_ADD(CURDATE(), INTERVAL 3 MONTH), '10:15:00', 'Bogotá', 'Lima', 3, 3, '13:15:00', DATE_ADD(CURDATE(), INTERVAL 3 MONTH)),
(46, 1204, DATE_ADD(CURDATE(), INTERVAL 4 MONTH), '16:45:00', 'Lima', 'Buenos Aires', 1, 1, '22:45:00', DATE_ADD(CURDATE(), INTERVAL 4 MONTH)),
(47, 1205, DATE_ADD(CURDATE(), INTERVAL 1 MONTH), '09:30:00', 'Lima', 'Quito', 2, 2, '11:30:00', DATE_ADD(CURDATE(), INTERVAL 1 MONTH)),
(48, 1206, DATE_ADD(CURDATE(), INTERVAL 45 DAY), '13:00:00', 'Quito', 'Lima', 3, 3, '15:00:00', DATE_ADD(CURDATE(), INTERVAL 45 DAY)),
(49, 1207, DATE_ADD(CURDATE(), INTERVAL 50 DAY), '17:20:00', 'Lima', 'Ciudad de México', 1, 1, '22:20:00', DATE_ADD(CURDATE(), INTERVAL 50 DAY)),
(50, 1208, DATE_ADD(CURDATE(), INTERVAL 59 DAY), '11:45:00', 'Lima', 'Panamá', 2, 2, '15:45:00', DATE_ADD(CURDATE(), INTERVAL 59 DAY));

INSERT INTO asientos (id, vuelos_id, disponibilidad, codigo_asiento, clase, valor) VALUES
(200, 43, 'DISPONIBLE', '1A', 'ECONOMICA', 300),
(201, 43, 'DISPONIBLE', '1B', 'ECONOMICA', 300),
(202, 43, 'DISPONIBLE', '1C', 'ECONOMICA', 300),
(203, 43, 'DISPONIBLE', '2A', 'EJECUTIVA', 500),
(204, 43, 'DISPONIBLE', '2B', 'EJECUTIVA', 500),
(205, 44, 'DISPONIBLE', '1A', 'ECONOMICA', 320),
(206, 44, 'DISPONIBLE', '1B', 'ECONOMICA', 320),
(207, 44, 'DISPONIBLE', '1C', 'ECONOMICA', 320),
(208, 44, 'OCUPADO', '2A', 'EJECUTIVA', 520),
(209, 45, 'DISPONIBLE', '1A', 'ECONOMICA', 280),
(210, 45, 'DISPONIBLE', '1B', 'ECONOMICA', 280),
(211, 45, 'DISPONIBLE', '1C', 'ECONOMICA', 280),
(212, 46, 'DISPONIBLE', '1A', 'ECONOMICA', 450),
(213, 46, 'DISPONIBLE', '1B', 'ECONOMICA', 450),
(214, 46, 'DISPONIBLE', '1C', 'ECONOMICA', 450),
(215, 47, 'DISPONIBLE', '1A', 'ECONOMICA', 200),
(216, 47, 'DISPONIBLE', '1B', 'ECONOMICA', 200),
(217, 47, 'DISPONIBLE', '1C', 'ECONOMICA', 200),
(218, 48, 'DISPONIBLE', '1A', 'ECONOMICA', 220),
(219, 48, 'DISPONIBLE', '1B', 'ECONOMICA', 220),
(220, 48, 'DISPONIBLE', '1C', 'ECONOMICA', 220),
(221, 49, 'DISPONIBLE', '1A', 'ECONOMICA', 380),
(222, 49, 'DISPONIBLE', '1B', 'ECONOMICA', 380),
(223, 49, 'DISPONIBLE', '1C', 'ECONOMICA', 380),
(224, 50, 'DISPONIBLE', '1A', 'ECONOMICA', 290),
(225, 50, 'DISPONIBLE', '1B', 'ECONOMICA', 290),
(226, 50, 'DISPONIBLE', '1C', 'ECONOMICA', 290);